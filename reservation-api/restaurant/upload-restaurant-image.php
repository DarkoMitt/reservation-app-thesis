...
$fileName = $data["fileName"] ?? "restaurant.jpg";
...
$cleanFileName = "restaurant_" . $restaurantId . "_" . time() . "_" . rand(1000, 9999) . "." . $extension;
...
$imageUrl = "http://10.0.2.2/reservation-api/uploads/restaurants/" . $cleanFileName;
